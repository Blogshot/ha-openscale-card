...
🚧 Work in progress, but functional: all three display modes are implemented.

## Preview

Same example data (weight, body fat %, muscle %, water %) shown in each of the three display modes:

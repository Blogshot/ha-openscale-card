 ...
 */class lt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let o=i._$litPart$;if(void 0===o){const t=s?.renderBefore??null;i._$litPart$=o=new tt(e.insertBefore(O(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}lt._$litElement$=!0,lt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:lt});const ct=rt.litElementPolyfillSupport;ct?.({LitElement:lt}),(rt.litElementVersions??=[]).push("4.2.2");const ht={sedentary:1.2,light:1.375,moderate:1.55,active:1.725,very_active:1.9},dt={weight:"Weight",body_fat:"Body Fat",water:"Water",muscle_mass:"Muscle Mass",bone_mass:"Bone Mass",visceral_fat:"Visceral Fat",waist:"Waist",hip:"Hip",bmi:"BMI",lbm:"LBM",fat_mass:"Fat Mass",muscle_mass_kg:"Muscle Mass",water_mass_kg:"Water Mass",bmr:"BMR",tdee:"TDEE"},pt={bmi:"Body Mass Index — weight relative to height (weight ÷ height²).",lbm:"Lean Body Mass — total weight minus fat mass.",bmr:"Basal Metabolic Rate — calories your body burns at complete rest.",tdee:"Total Daily Energy Expenditure — BMR scaled by your activity level."},ut={bmi:"",lbm:"kg",fat_mass:"kg",muscle_mass_kg:"kg",water_mass_kg:"kg",bmr:"kcal",tdee:"kcal"},mt={bmi:1,lbm:1,fat_mass:1,muscle_mass_kg:1,water_mass_kg:1,bmr:0,tdee:0},ft=[{name:"title",selector:{text:{}}},{name:"gender",label:"Gender",selector:{select:{mode:"dropdown",options:[{value:"male",label:"Male"},{value:"female",label:"Female"}]}}},{name:"display_mode",label:"Display mode",selector:{select:{mode:"dropdown",options:[{value:"grid",label:"Grid"},{value:"callouts",label:"Callouts"},{value:"donut",label:"Donut (needs body fat %, water % and muscle mass %)"}]}}},{name:"height_cm",label:"Height in cm (only needed for BMI)",selector:{number:{min:50,max:250,mode:"box"}}},{name:"activity_level",label:"Activity level (only needed for TDEE)",selector:{select:{mode:"dropdown",options:Object.keys(ht).map(t=>({value:t,label:t.split("_").map(t=>t[0].toUpperCase()+t.slice(1)).join(" ")}))}}}],yt=[{key:"weight",field:"weight_entity",label:"Weight"},{key:"body_fat",field:"body_fat_entity",label:"Body fat"},{key:"muscle_mass",field:"muscle_mass_entity",label:"Muscle mass"},{key:"water",field:"water_entity",label:"Water"},{key:"bone_mass",field:"bone_mass_entity",label:"Bone mass (not published by openScale-sync)"},{key:"visceral_fat",field:"visceral_fat_entity",label:"Visceral fat (not published by openScale-sync)"},{key:"waist",field:"waist_entity",label:"Waist (not published by openScale-sync)"},{key:"hip",field:"hip_entity",label:"Hip (not published by openScale-sync)"}],gt=yt.map(({field:t,label:e})=>({name:t,label:e,selector:{entity:{domain:"sensor"}}})),$t=[{key:"bmi",field:"show_bmi",label:"BMI"},{key:"lbm",field:"show_lbm",label:"Lean body mass"},{key:"fat_mass",field:"show_fat_mass",label:"Fat mass (kg)"},{key:"muscle_mass_kg",field:"show_muscle_mass_kg",label:"Muscle mass (kg)"},{key:"water_mass_kg",field:"show_water_mass_kg",label:"Water mass (kg)"},{key:"bmr",field:"show_bmr",label:"BMR"},{key:"tdee",field:"show_tdee",label:"TDEE"}],_t=$t.map(({field:t,label:e})=>({name:t,label:e,selector:{boolean:{}}}));class bt extends lt{constructor(){super(...arguments),this._computeLabel=t=>t.label??t.name,this._generalChanged=t=>{if(!this.config)return;const e=t.detail.value;this._fireConfigChanged({...this.config,title:e.title||void 0,gender:e.gender,display_mode:e.display_mode,height_cm:e.height_cm,activity_level:e.activity_level})},this._entityMetricsChanged=t=>{if(!this.config)return;const e=t.detail.value,s={...this.config.metrics};for(const{key:t,field:i}of yt){const o=e[i];o?s[t]={...s[t],entity:o}:delete s[t]}this._fireConfigChanged({...this.config,metrics:s})},this._computedMetricsChanged=t=>{if(!this.config)return;const e=t.detail.value,s={...this.config.metrics};for(const{key:t,field:i}of $t)e[i]?s[t]=s[t]??{}:delete s[t];this._fireConfigChanged({...this.config,metrics:s})},this._goalsChanged=t=>{if(!this.config)return;const e=t.detail.value,s={...this.config.metrics};for(const{key:t,field:i}of this._goalFields){const o=e[i];if(null==o){const e={...s[t]};delete e.goal,s[t]=e}else s[t]={...s[t],goal:o}}this._fireConfigChanged({...this.config,metrics:s})}}setConfig(t){this.config=t}set hass(t){this.hassObj=t,this.requestUpdate()}get _generalData(){const t=this.config;return{title:t.title??"",gender:t.gender??"male",display_mode:t.display_mode??"grid",height_cm:t.height_cm,activity_level:t.activity_level}}get _entityMetricsData(){const t=this.config.metrics,e={};for(const{key:s,field:i}of yt)e[i]=t[s]?.entity;return e}get _computedMetricsData(){const t=this.config.metrics,e={};for(const{key:s,field:i}of $t)e[i]=!!t[s];return e}get _goalFields(){return Object.keys(this.config.metrics).map(t=>({key:t,field:`goal_${t}`}))}get _goalsSchema(){return this._goalFields.map(({key:t,field:e})=>({name:e,label:dt[t],selector:{number:{mode:"box"}}}))}get _goalsData(){const t=this.config.metrics,e={};for(const{key:s,field:i}of this._goalFields)e[i]=t[s]?.goal;return e}_fireConfigChanged(t){this.config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){return this.config&&this.hassObj?Q`
  ...
  `,customElements.define("openscale-card-editor",bt);function Et(t,e="var(--secondary-text-color, #8892a6)"){const s=function(t){return"female"===t?{headCx:110,headCy:27,headR:15,facets:[{points:"110,85 86,52 134,52",opacity:1},{points:"110,85 134,52 124,94",opacity:.85},{points:"110,85 124,94 140,122",opacity:1},{points:"110,85 140,122 80,122",opacity:.7},{points:"110,85 80,122 96,94",opacity:.85},{points:"110,85 96,94 86,52",opacity:.7},{points:"86,58 60,98 92,72",opacity:.85},{points:"60,98 70,107 92,72",opacity:1},{points:"134,58 160,98 128,72",opacity:.85},{points:"160,98 150,107 128,72",opacity:1},{points:"80,122 101,122 99,166",opacity:1},{points:"80,122 99,166 82,216",opacity:.7},{points:"101,122 99,166 100,216",opacity:.85},{points:"99,166 100,216 82,216",opacity:.7},{points:"140,122 119,122 121,166",opacity:1},{points:"140,122 121,166 138,216",opacity:.7},{points:"119,122 121,166 120,216",opacity:.85},{points:"121,166 120,216 138,216",opacity:.7}]}:{headCx:110,headCy:27,headR:16,facets:[{points:"110,90 79,54 141,54",opacity:1},{points:"110,90 141,54 129,94",opacity:.85},{points:"110,90 129,94 134,122",opacity:1},{points:"110,90 134,122 86,122",opacity:.7},{points:"110,90 86,122 91,94",opacity:.85},{points:"110,90 91,94 79,54",opacity:.7},{points:"79,60 50,100 88,72",opacity:.85},{points:"50,100 60,109 88,72",opacity:1},{points:"141,60 170,100 132,72",opacity:.85},{points:"170,100 160,109 132,72",opacity:1},{points:"86,122 103,122 100,168",opacity:1},{points:"86,122 100,168 80,216",opacity:.7},{points:"103,122 100,168 100,216",opacity:.85},{points:"100,168 100,216 80,216",opacity:.7},{points:"134,122 117,122 120,168",opacity:1},{points:"134,122 120,168 140,216",opacity:.7},{points:"117,122 120,168 120,216",opacity:.85},{points:"120,168 120,216 140,216",opacity:.7}]}}(t);return z`
    <g fill=${e}>
      <circle cx=${s.headCx} cy=${s.headCy} r=${s.headR}></circle>
      ${s.facets.map(t=>z`<polygon points=${t.points} fill-opacity=${t.opacity}></polygon>`)}
    </g>
  `}function St(t){return t?Q`<span class="hint-icon" title=${t}>ⓘ</span>`:""}const Ct=1e-6;class kt{constructor(t){this.previous=new Map,this.lastTrend=new Map,this.lastQuality=new Map,this.seeding=new Set,this.onSeeded=t}update(t,e,s,i){const o=this.previous.get(t);if(void 0===o)return this.trySeedFromHistory(t,e,s),void this.previous.set(t,e);if(Math.abs(e-o)<Ct)return this.lastTrend.get(t)??"flat";const n=e>o?"up":"down";return this.previous.set(t,e),this.lastTrend.set(t,n),this.lastQuality.set(t,function(t,e,s){if(void 0===s)return"neutral";const i=Math.abs(t-s),o=Math.abs(e-s);return o<i-Ct?"good":o>i+Ct?"bad":"neutral"}(o,e,i)),n}getQuality(t){return this.lastQuality.get(t)??"neutral"}trySeedFromHistory(t,e,s){s?.entityId&&!this.seeding.has(t)&&(this.seeding.add(t),async function(t,e){try{const s=new Date(Date.now()-2592e6).toISOString(),i=(new Date).toISOString(),o=`history/period/${s}?filter_entity_id=${encodeURIComponent(e)}&end_time=${encodeURIComponent(i)}&minimal_response`,n=await t.callApi("GET",o),a=Array.isArray(n)?n[0]:void 0;if(!Array.isArray(a)||a.length<2)return;for(let t=a.length-2;t>=0;t--){const e=parseFloat(a[t]?.state??"");if(Number.isFinite(e))return e}return}catch{return}}(s.hass,s.entityId).then(s=>{void 0!==s&&this.previous.get(t)===e&&(this.previous.set(t,s),this.onSeeded?.())}))}}const Mt={up:"↑",down:"↓",flat:"→"};function Pt(t,e="neutral"){return t?Q`<span class="trend trend-${e}">${Mt[t]}</span>`:q}function Ot(t,e="neutral"){return t?z` <tspan class="trend trend-${e}">${Mt[t]}</tspan>`:q}const Ut=2*Math.PI*82,Tt=230,Ht=115,Rt="#5b8def",Nt="#5bd18b",Dt="#e6b85b",Bt="#e05b5b",jt="#8892a6",Lt=new Set(["water","water_mass_kg","body_fat","fat_mass","muscle_mass","muscle_mass_kg","bone_mass"]);function It(t,e){return t.find(t=>t.key===e)}function Ft(t){const e=It(t,"water"),s=It(t,"body_fat"),i=It(t,"muscle_mass"),o=It(t,"bone_mass"),n=function(t){const e=It(t,"bone_mass");if(!e)return 0;if("%"===e.unit)return e.value;const s=It(t,"weight");return s&&s.value>0?e.value/s.value*100:0}(t),a=function(t,e,s,i=0){const o=t+e+s+i;if(o<=100)return{water:t,muscle:e,fat:s,bone:i,other:100-o};const n=100/o;return{water:t*n,muscle:e*n,fat:s*n,bone:i*n,other:0}}(e.value,i.value,s.value,n);return[{key:"water",label:"Water",pct:e.value,arcPct:a.water,color:Rt,trend:e.trend,trendQuality:e.trendQuality},{key:"muscle",label:"Muscle",pct:i.value,arcPct:a.muscle,color:Nt,trend:i.trend,trendQuality:i.trendQuality},{key:"fat",label:"Fat",pct:s.value,arcPct:a.fat,color:Dt,trend:s.trend,trendQuality:s.trendQuality},{key:"bone",label:"Bone",pct:n,arcPct:a.bone,color:Bt,trend:o?.trend,trendQuality:o?.trendQuality??"neutral"},{key:"other",label:"Other",pct:a.other,arcPct:a.other,color:jt,trendQuality:"neutral"}].filter(t=>t.arcPct>.05)}function Qt(t,e){const s=t*Math.PI/180;return{x:Tt+e*Math.sin(s),y:Ht-e*Math.cos(s)}}const zt=620;class Wt extends lt{constructor(){super(...arguments),this.trendTracker=new kt}setConfig(t){if(!t||!t.metrics)throw new Error('Invalid configuration: "metrics" is required.');this.config={...t,display_mode:t.display_mode??"grid",gender:t.gender??"male"},this.trendTracker=new kt(()=>this.requestUpdate())}set hass(t){this.hassObj=t,this.requestUpdate()}getCardSize(){switch(this.config?.display_mode){case"callouts":case"donut":return 6;default:return 4}}static getConfigElement(){return document.createElement("openscale-card-editor")}static getStubConfig(){return{type:"custom:openscale-card",gender:"male",display_mode:"grid",metrics:{weight:{},body_fat:{},muscle_mass:{},water:{}}}}render(){if(!this.config||!this.hassObj)return Q``;const t=this.config,e=t.gender??"male",s=function(t,e,s){const i=Object.entries(e.metrics),o=[];for(const[n,a]of i){if(!a)continue;let i,r,l;if(a.entity){const e=t.states[a.entity],s=e?parseFloat(e.state):NaN;if(!e||!Number.isFinite(s))continue;i=s,r=e.state,l=e.attributes?.unit_of_measurement??""}else{const s=At(n,t,e.metrics,e);if(void 0===s)continue;i=s,r=s.toFixed(mt[n]??1),l=ut[n]??""}const c=a.entity&&"function"==typeof t.callApi?s.update(n,i,{hass:{callApi:t.callApi.bind(t)},entityId:a.entity},a.goal):s.update(n,i,void 0,a.goal);o.push({key:n,label:dt[n],value:i,formatted:r,unit:l,trend:c,trendQuality:s.getQuality(n),hint:pt[n]})}return o}(this.hassObj,t,this.trendTracker),i=t.display_mode??"grid",o="donut"===i&&function(t){return!!It(t,"water")&&!!It(t,"body_fat")&&!!It(t,"muscle_mass")}(s)?function(t,e){const s=Ft(t);let i=0;const o=s.map(t=>{const e=t.arcPct/100,s=Math.max(0,e*Ut-4),o=-i,n=(i/Ut*360+180*e)%360;return i+=e*Ut,{segment:t,length:s,dashoffset:o,angle:n,point:Qt(n,100)}}),n=o.filter(t=>t.point.x<Tt).sort((t,e)=>t.point.y-e.point.y),a=o.filter(t=>t.point.x>=Tt).sort((t,e)=>t.point.y-e.point.y),r=Math.max(n.length,a.length,1),l=Math.max(243,40+32*r+20),c=(t,e)=>e<=1?l/2:40+t*(l-40-20)/(e-1),h=n.map((t,e)=>({...t,labelY:c(e,n.length)})),d=a.map((t,e)=>({...t,labelY:c(e,a.length)})),p=t.filter(t=>!Lt.has(t.key));return Q`
    <div class="donut-mode">
      <svg class="donut-ring" viewBox="0 0 ${460} ${l}">
        <g transform="translate(${Tt}, ${Ht}) rotate(-90)">
          ${o.map(({segment:t,length:e,dashoffset:s})=>z`
              <circle
                r=${82}
                fill="none"
                stroke=${t.color}
                stroke-width=${16}
                stroke-dasharray="${e} ${Ut}"
                stroke-dashoffset=${s}
              ></circle>
            `)}
        </g>
        <g transform="translate(${Tt}, ${Ht}) scale(0.55) translate(-110, -115)">
          ${Et(e)}
        </g>
        ${h.map(({segment:t,point:e,labelY:s})=>z`
            ...
            <text x=${85} y=${s+13} class="callout-value" text-anchor="end">
              ${t.pct.toFixed(1)}%${Ot(t.trend,t.trendQuality)}
            </text>
          `)}
        ${d.map(({segment:t,point:e,labelY:s})=>z`
            ...
            <div class="donut-extra">
              ${p.map(t=>Q`
                  <div class="row">
                    ...
                    <span class="value">${t.formatted} ${t.unit} ${Pt(t.trend,t.trendQuality)}</span>
                  </div>
                `)}
            </div>
          `:""}
    ...
    <svg class="callouts-mode" viewBox="0 0 ${zt} ${n}">
      ...
      ${r.map(({row:t,y:e})=>z`
          <text
            ...
            text-anchor="end"
          >
            ${t.label}${t.hint?z`<title>${t.hint}</title>`:""}
          </text>
          <text x=${85} y=${e+12} class="callout-value" text-anchor="end">
            ${t.formatted} ${t.unit}${Ot(t.trend,t.trendQuality)}
          </text>
        `)}
      ${l.map(({row:t,y:e})=>z`
          <text
  ...
  `,customElements.define("openscale-card",Wt);const qt=window;qt.customCards=qt.customCards||[],qt.customCards.push({type:"openscale-card",name:"OpenScale Card",description:"Displays openScale-sync body composition data as a schematic body silhouette."});export{Wt as OpenscaleCard};

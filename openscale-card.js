    ...
    <svg class="callouts-mode" viewBox="0 0 ${Wt} ${o}">
      ...
      ${l.map(({row:t,y:e})=>Q`
          ...
          <text x=${535} y=${e+12} class="callout-value" text-anchor="start">
            ${Ut(t.trend,t.trendQuality)} ${t.formatted} ${t.unit}
          </text>
        `)}
    </svg>

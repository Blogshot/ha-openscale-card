 ...
 */class lt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let o=i._$litPart$;if(void 0===o){const t=s?.renderBefore??null;i._$litPart$=o=new tt(e.insertBefore(O(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}}lt._$litElement$=!0,lt.finalized=!0,at.litElementHydrateSupport?.({LitElement:lt});const ct=at.litElementPolyfillSupport;ct?.({LitElement:lt}),(at.litElementVersions??=[]).push("4.2.2");const ht={sedentary:1.2,light:1.375,moderate:1.55,active:1.725,very_active:1.9},dt={weight:"Weight",body_fat:"Body Fat",water:"Water",muscle_mass:"Muscle Mass",bone_mass:"Bone Mass",visceral_fat:"Visceral Fat",waist:"Waist",hip:"Hip",bmi:"BMI",lbm:"LBM",fat_mass:"Fat Mass",muscle_mass_kg:"Muscle Mass",water_mass_kg:"Water Mass",bmr:"BMR",tdee:"TDEE"},pt={bmi:"Body Mass Index — weight relative to height (weight ÷ height²).",lbm:"Lean Body Mass — total weight minus fat mass.",bmr:"Basal Metabolic Rate — calories your body burns at complete rest.",tdee:"Total Daily Energy Expenditure — BMR scaled by your activity level."},ut={bmi:"",lbm:"kg",fat_mass:"kg",muscle_mass_kg:"kg",water_mass_kg:"kg",bmr:"kcal",tdee:"kcal"},mt={bmi:1,lbm:1,fat_mass:1,muscle_mass_kg:1,water_mass_kg:1,bmr:0,tdee:0},ft=[{name:"title",selector:{text:{}}},{name:"gender",label:"Gender",selector:{select:{mode:"dropdown",options:[{value:"male",label:"Male"},{value:"female",label:"Female"}]}}},{name:"display_mode",label:"Display mode",selector:{select:{mode:"dropdown",options:[{value:"grid",label:"Grid"},{value:"callouts",label:"Callouts"},{value:"donut",label:"Donut (needs body fat %, water % and muscle mass %)"}]}}},{name:"height_cm",label:"Height in cm (only needed for BMI)",selector:{number:{min:50,max:250,mode:"box"}}},{name:"activity_level",label:"Activity level (only needed for TDEE)",selector:{select:{mode:"dropdown",options:Object.keys(ht).map(t=>({value:t,label:t.split("_").map(t=>t[0].toUpperCase()+t.slice(1)).join(" ")}))}}}],$t=[{key:"weight",field:"weight_entity",label:"Weight"},{key:"body_fat",field:"body_fat_entity",label:"Body fat"},{key:"muscle_mass",field:"muscle_mass_entity",label:"Muscle mass"},{key:"water",field:"water_entity",label:"Water"},{key:"bone_mass",field:"bone_mass_entity",label:"Bone mass (not published by openScale-sync)"},{key:"visceral_fat",field:"visceral_fat_entity",label:"Visceral fat (not published by openScale-sync)"},{key:"waist",field:"waist_entity",label:"Waist (not published by openScale-sync)"},{key:"hip",field:"hip_entity",label:"Hip (not published by openScale-sync)"}],yt=$t.map(({field:t,label:e})=>({name:t,label:e,selector:{entity:{domain:"sensor"}}})),_t=[{key:"bmi",field:"show_bmi",label:"BMI"},{key:"lbm",field:"show_lbm",label:"Lean body mass"},{key:"fat_mass",field:"show_fat_mass",label:"Fat mass (kg)"},{key:"muscle_mass_kg",field:"show_muscle_mass_kg",label:"Muscle mass (kg)"},{key:"water_mass_kg",field:"show_water_mass_kg",label:"Water mass (kg)"},{key:"bmr",field:"show_bmr",label:"BMR"},{key:"tdee",field:"show_tdee",label:"TDEE"}],gt=_t.map(({field:t,label:e})=>({name:t,label:e,selector:{boolean:{}}}));class bt extends lt{constructor(){super(...arguments),this._computeLabel=t=>t.label??t.name,this._generalChanged=t=>{if(!this.config)return;const e=t.detail.value;this._fireConfigChanged({...this.config,title:e.title||void 0,gender:e.gender,display_mode:e.display_mode,height_cm:e.height_cm,activity_level:e.activity_level})},this._entityMetricsChanged=t=>{if(!this.config)return;const e=t.detail.value,s={...this.config.metrics};for(const{key:t,field:i}of $t){const o=e[i];o?s[t]={...s[t],entity:o}:delete s[t]}this._fireConfigChanged({...this.config,metrics:s})},this._computedMetricsChanged=t=>{if(!this.config)return;const e=t.detail.value,s={...this.config.metrics};for(const{key:t,field:i}of _t)e[i]?s[t]=s[t]??{}:delete s[t];this._fireConfigChanged({...this.config,metrics:s})}}setConfig(t){this.config=t}set hass(t){this.hassObj=t,this.requestUpdate()}get _generalData(){const t=this.config;return{title:t.title??"",gender:t.gender??"male",display_mode:t.display_mode??"grid",height_cm:t.height_cm,activity_level:t.activity_level}}get _entityMetricsData(){const t=this.config.metrics,e={};for(const{key:s,field:i}of $t)e[i]=t[s]?.entity;return e}get _computedMetricsData(){const t=this.config.metrics,e={};for(const{key:s,field:i}of _t)e[i]=!!t[s];return e}_fireConfigChanged(t){this.config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){return this.config&&this.hassObj?W`
      ...
      ></ha-form>
    `:W``}}function vt(t,e){return t*(e/100)}function xt(t){return 370+21.6*t}function wt(t,e,s){const i=e[s]?.entity;if(!i)return;const o=t.states[i];if(!o)return;const n=parseFloat(o.state);return Number.isFinite(n)?n:void 0}function At(t,e,s,i){const o=wt(e,s,"weight"),n=wt(e,s,"body_fat"),r=void 0!==o&&void 0!==n?(a=o)-vt(a,n):void 0;var a,l,c;switch(t){case"fat_mass":return void 0!==o&&void 0!==n?vt(o,n):void 0;case"muscle_mass_kg":{const t=wt(e,s,"muscle_mass");return void 0!==o&&void 0!==t?function(t,e){return t*(e/100)}(o,t):void 0}case"water_mass_kg":{const t=wt(e,s,"water");return void 0!==o&&void 0!==t?function(t,e){return t*(e/100)}(o,t):void 0}case"lbm":return r;case"bmi":return void 0!==o&&i.height_cm?function(t,e){const s=e/100;return t/(s*s)}(o,i.height_cm):void 0;case"bmr":return void 0!==r?xt(r):void 0;case"tdee":{const t=void 0!==r?xt(r):void 0;return void 0!==t&&i.activity_level?(l=t,c=i.activity_level,l*ht[c]):void 0}default:return}}bt.styles=n`
    .section-title {
      font-weight: 600;
      margin: 20px 0 8px;
    }
  ...
  `}function St(t){return t?W`<span class="hint-icon" title=${t}>ⓘ</span>`:""}class Ct{constructor(t){this.previous=new Map,this.storagePrefix=t?`openscale-card-trend:${t}:`:void 0}update(t,e){const s=this.previous.get(t)??this.readPersisted(t);if(this.previous.set(t,e),this.writePersisted(t,e),void 0===s)return;const i=e-s;return Math.abs(i)<1e-6?"flat":i>0?"up":"down"}readPersisted(t){if(this.storagePrefix&&"undefined"!=typeof localStorage)try{const e=localStorage.getItem(this.storagePrefix+t);if(null===e)return;const s=parseFloat(e);return Number.isFinite(s)?s:void 0}catch{return}}writePersisted(t,e){if(this.storagePrefix&&"undefined"!=typeof localStorage)try{localStorage.setItem(this.storagePrefix+t,String(e))}catch{}}}const kt={up:"↑",down:"↓",flat:"→"};function Mt(t){return t?W`<span class="trend trend-${t}">${kt[t]}</span>`:V}const Pt=2*Math.PI*82,Ot=230,Ut=115,Tt="#5b8def",Ht="#5bd18b",Rt="#e6b85b",Nt="#e05b5b",Bt="#8892a6",Dt=new Set(["water","water_mass_kg","body_fat","fat_mass","muscle_mass","muscle_mass_kg","bone_mass"]);function jt(t,e){return t.find(t=>t.key===e)}function Lt(t){const e=jt(t,"water"),s=jt(t,"body_fat"),i=jt(t,"muscle_mass"),o=jt(t,"bone_mass"),n=function(t){const e=jt(t,"bone_mass");if(!e)return 0;if("%"===e.unit)return e.value;const s=jt(t,"weight");return s&&s.value>0?e.value/s.value*100:0}(t),r=function(t,e,s,i=0){const o=t+e+s+i;if(o<=100)return{water:t,muscle:e,fat:s,bone:i,other:100-o};const n=100/o;return{water:t*n,muscle:e*n,fat:s*n,bone:i*n,other:0}}(e.value,i.value,s.value,n);return[{key:"water",label:"Water",pct:e.value,arcPct:r.water,color:Tt,trend:e.trend},{key:"muscle",label:"Muscle",pct:i.value,arcPct:r.muscle,color:Ht,trend:i.trend},{key:"fat",label:"Fat",pct:s.value,arcPct:r.fat,color:Rt,trend:s.trend},{key:"bone",label:"Bone",pct:n,arcPct:r.bone,color:Nt,trend:o?.trend},{key:"other",label:"Other",pct:r.other,arcPct:r.other,color:Bt}].filter(t=>t.arcPct>.05)}function It(t,e){const s=t*Math.PI/180;return{x:Ot+e*Math.sin(s),y:Ut-e*Math.cos(s)}}const zt=620;class Wt extends lt{constructor(){super(...arguments),this.trendTracker=new Ct}setConfig(t){if(!t||!t.metrics)throw new Error('Invalid configuration: "metrics" is required.');this.config={...t,display_mode:t.display_mode??"grid",gender:t.gender??"male"},this.trendTracker=new Ct(function(t){const e=Object.values(t.metrics).map(t=>t?.entity).filter(t=>!!t).sort();return e.length?e.join("|"):void 0}(this.config))}set hass(t){this.hassObj=t,this.requestUpdate()}getCardSize(){switch(this.config?.display_mode){case"callouts":case"donut":return 6;default:return 4}}static getConfigElement(){return document.createElement("openscale-card-editor")}static getStubConfig(){return{type:"custom:openscale-card",gender:"male",display_mode:"grid",metrics:{weight:{},body_fat:{},muscle_mass:{},water:{}}}}render(){if(!this.config||!this.hassObj)return W``;const t=this.config,e=t.gender??"male",s=function(t,e,s){const i=Object.entries(e.metrics),o=[];for(const[n,r]of i){if(!r)continue;let i,a,l;if(r.entity){const e=t.states[r.entity],s=e?parseFloat(e.state):NaN;if(!e||!Number.isFinite(s))continue;i=s,a=e.state,l=e.attributes?.unit_of_measurement??""}else{const s=At(n,t,e.metrics,e);if(void 0===s)continue;i=s,a=s.toFixed(mt[n]??1),l=ut[n]??""}o.push({key:n,label:dt[n],value:i,formatted:a,unit:l,trend:s.update(n,i),hint:pt[n]})}return o}(this.hassObj,t,this.trendTracker),i=t.display_mode??"grid",o="donut"===i&&function(t){return!!jt(t,"water")&&!!jt(t,"body_fat")&&!!jt(t,"muscle_mass")}(s)?function(t,e){const s=Lt(t);let i=0;const o=s.map(t=>{const e=t.arcPct/100,s=Math.max(0,e*Pt-4),o=-i,n=(i/Pt*360+180*e)%360;return i+=e*Pt,{segment:t,length:s,dashoffset:o,angle:n,point:It(n,100)}}),n=o.filter(t=>t.point.x<Ot).sort((t,e)=>t.point.y-e.point.y),r=o.filter(t=>t.point.x>=Ot).sort((t,e)=>t.point.y-e.point.y),a=Math.max(n.length,r.length,1),l=Math.max(243,40+32*a+20),c=(t,e)=>e<=1?l/2:40+t*(l-40-20)/(e-1),h=n.map((t,e)=>({...t,labelY:c(e,n.length)})),d=r.map((t,e)=>({...t,labelY:c(e,r.length)})),p=t.filter(t=>!Dt.has(t.key));return W`
    <div class="donut-mode">
      <svg class="donut-ring" viewBox="0 0 ${460} ${l}">
        ...
        ${h.map(({segment:t,point:e,labelY:s})=>F`
          ...
          `)}
        ${d.map(({segment:t,point:e,labelY:s})=>F`
  ...
  `}(s,e):"callouts"===i?function(t,e){const s=t.filter((t,e)=>e%2==0),i=t.filter((t,e)=>e%2==1),o=Math.max(s.length,i.length,1),n=Math.max(240,55+34*o+20),r=(t,e)=>e<=1?n/2:55+t*(n-55-20)/(e-1),a=s.map((t,e)=>({row:t,y:r(e,s.length),anchorX:270})),l=i.map((t,e)=>({row:t,y:r(e,i.length),anchorX:350}));return W`
  ...
  `,customElements.define("openscale-card",Wt);const Ft=window;Ft.customCards=Ft.customCards||[],Ft.customCards.push({type:"openscale-card",name:"OpenScale Card",description:"Displays openScale-sync body composition data as a schematic body silhouette."});export{Wt as OpenscaleCard};
